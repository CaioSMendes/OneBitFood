...
pc = ProductCategory.create!(tittle: 'Pratos Mexicanos', restaurant: r)
...
pc = ProductCategory.create!(tittle: 'Porções', restaurant: r)
...
pc = ProductCategory.create!(tittle: 'Fogazzas (Individuais)', restaurant: r)
...
pc = ProductCategory.create!(tittle: 'Entrada', restaurant: r)
...
pc = ProductCategory.create!(tittle: 'Saladas, molhos e wraps', restaurant: r)
...
puts 'Seed cadastrado com sucesso !!!'
